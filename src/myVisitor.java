...
//    }
    ...
    @Override
    public Integer visitExpr_relop(arithmeticParser.Expr_relopContext ctx) {
        Integer result = 0;
...
//    @Override
//    public Integer visite(arithmeticParser.Epr_relopContext ctx) {
//        Integer result = 0;
//        switch (visit(ctx.relop())) {
//            case 0:
//                if (visit(ctx.expression(0))==visit(ctx.expression(1))) {
...
//    public Integer visitExpr_relop(arithmeticParser.Expr_relopContext ctx) {
//        Integer result = 0;
//        System.out.println("expr: " + visit(ctx.expression(0)) + " expr_2: " + visit(ctx.expression(1)));
//        switch (visit(ctx.relop())) {
//            case 0:
//                if (visit(ctx.expression(0))==visit(ctx.expression(1))) {
//                    result = 1;
...
//
//    @Override
//    public Integer visitWhile_statement(arithmeticParser.While_statementContext ctx) {
//        Integer result = 0;
//
//        if (visit(ctx.cond)==1){
//            result = visit(ctx.then)+visit(ctx.then);
//        }
//        return result;
//    }
//
